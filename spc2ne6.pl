...
# Nada and van der Eerden's six-center water
...
$doh = 0.9800;
# oxygen - extra point distance
$doe = 0.2300;
# oxygen - lone pair distance
$dol = 0.8892;
# H-O-H angle
$ahoh = 108.0;
$ahoh = $ahoh * $cf;
...
#print("oh2 coords: $oh2[0] $oh2[1] $oh2[2]\n");
      ...
      # write the water
      printf("%-6s%5d%4s  %3s  %4d    %8.3f%8.3f%8.3f\n", ATOM, $natom + 5, OW, NE6, $nres, $o[0], $o[1], $o[2]);
      printf("%-6s%5d%4s  %3s  %4d    %8.3f%8.3f%8.3f\n", ATOM, $natom, HW1, NE6, $nres, $h1[0], $h1[1], $h1[2]);
      printf("%-6s%5d%4s  %3s  %4d    %8.3f%8.3f%8.3f\n", ATOM, $natom + 1, HW2, NE6, $nres, $h2[0], $h2[1], $h2[2]);
      printf("%-6s%5d%4s  %3s  %4d    %8.3f%8.3f%8.3f\n", ATOM, $natom + 2, LP1, NE6, $nres, $l1[0], $l1[1], $l1[2]);
      printf("%-6s%5d%4s  %3s  %4d    %8.3f%8.3f%8.3f\n", ATOM, $natom + 3, LP2, NE6, $nres, $l2[0], $l2[1], $l2[2]);
      printf("%-6s%5d%4s  %3s  %4d    %8.3f%8.3f%8.3f\n", ATOM, $natom + 4, EP, NE6, $nres, $ep[0], $ep[1], $ep[2]);
      print("TER\n");
      $nres++;
      $natom += 6;
      $ac = 0;
